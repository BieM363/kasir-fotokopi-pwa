    ...
    <>
      ...
      <main className="max-w-lg mx-auto p-4 space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-primary-800 text-white rounded-xl shadow-sm p-4 border border-primary-900">
            <p className="text-primary-200 text-sm font-semibold">Omzet Hari Ini</p>
            <p className="text-2xl font-bold mt-1 text-white">{formatCurrency(stats.revenue)}</p>
          </div>
          <Card>
        ...
        <div className="bg-slate-100 border border-dashed border-slate-300 rounded-xl p-4 text-center space-y-1">
